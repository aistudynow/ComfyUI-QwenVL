...
class aistudynow_QwenVL_PromptEnhancer(QwenVLBase):
...
NODE_CLASS_MAPPINGS = {
    "aistudynow_QwenVL_PromptEnhancer": aistudynow_QwenVL_PromptEnhancer,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "aistudynow_QwenVL_PromptEnhancer": "QwenVL Prompt Enhancer",
}
