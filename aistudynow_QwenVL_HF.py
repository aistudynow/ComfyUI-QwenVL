...
class aistudynow_QwenVL_HF(QwenVLBase):
    @classmethod
    def INPUT_TYPES(cls):
...
class aistudynow_QwenVL_HF_Advanced(QwenVLBase):
    @classmethod
    def INPUT_TYPES(cls):
        models = list(HF_VL_MODELS.keys())
        default_model = models[0] if models else "Qwen3-VL-4B-Instruct"
...
NODE_CLASS_MAPPINGS = {
    "aistudynow_QwenVL_HF": aistudynow_QwenVL_HF,
    "aistudynow_QwenVL_HF_Advanced": aistudynow_QwenVL_HF_Advanced,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "aistudynow_QwenVL_HF": "QwenVL (HF Alt)",
    "aistudynow_QwenVL_HF_Advanced": "QwenVL (HF Alt Advanced)",
}
